package com.bigdata.flink.window.checkpoint;
...
public class SocketWindowWordCountJavaCheckPoint {
    public static void main(String[] args) throws Exception {
        ...
        String delimiter = "\n";
        //连接socket获取输入的数据
        DataStreamSource<String> text = env.socketTextStream("192.168.101.216", port);
        ...
        DataStream<WordWithCount> windowCounts = text.flatMap(new FlatMapFunction<String, WordWithCount>() {
            public void flatMap(String value, Collector<WordWithCount> out) throws Exception {
                ...
                .timeWindow(Time.seconds(5))//指定时间窗口大小为2秒，指定时间间隔为1秒
