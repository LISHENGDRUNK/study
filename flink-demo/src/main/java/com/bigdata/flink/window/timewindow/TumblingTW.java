...
/**
 * @Time : 2019/10/23 0023 17:17
 * @Author : lisheng
 * @Description: 每5秒钟统计一次，在这过去的5秒钟内，各个路口通过红绿灯汽车的数量。无重叠数据
 **/
public class TumblingTW {
...
//        case class CarWc(sensorId: Int, carCnt: Int)
        ...
        //6.触发流计算
        try {
            JobExecutionResult execute = env.execute(Thread.currentThread().getStackTrace()[1].getClassName());
        } catch (Exception e) {
            e.printStackTrace();
        }
